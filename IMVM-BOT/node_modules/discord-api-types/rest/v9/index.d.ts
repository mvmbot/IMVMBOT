...
export declare const Routes: {
     ...
     */
    threads(parentId: Snowflake, messageId?: Snowflake): `/channels/${string}/messages/${string}/threads` | `/channels/${string}/threads`;
    /**
     * Route for:
     ...
     */
    channelThreads(channelId: Snowflake, archived?: 'private' | 'public'): `/channels/${string}/threads/archived/private` | `/channels/${string}/threads/archived/public` | `/channels/${string}/threads/active`;
    /**
     * Route for:
     ...
     */
    threadMembers(threadId: Snowflake, userId?: Snowflake | '@me'): `/channels/${string}/thread-members/${string}` | `/channels/${string}/thread-members`;
    /**
     * Route for:
     * - GET   `/users/@me`
     * - GET   `/users/{user.id}`
     ...
     */
    webhook(webhookId: Snowflake, webhookToken?: string): `/webhooks/${string}/${string}` | `/webhooks/${string}`;
    /**
     * Route for:
...
export declare const CDNRoutes: {
     ...
     * This route supports the extensions: PNG, JPEG, WebP, GIF
     */
    guildIcon<Format_1 extends GuildIconFormat>(guildId: Snowflake, guildIcon: string, format: Format_1): `icons/${string}/${string}.${Format_1}`;
    /**
     * Route for:
     ...
     */
    guildSplash<Format_2 extends GuildSplashFormat>(guildId: Snowflake, guildSplash: string, format: Format_2): `/splashes/${string}/${string}.${Format_2}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    guildDiscoverySplash<Format_3 extends GuildDiscoverySplashFormat>(guildId: Snowflake, guildDiscoverySplash: string, format: Format_3): `/discovery-splashes/${string}/${string}.${Format_3}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP, GIF
     */
    guildBanner<Format_4 extends GuildBannerFormat>(guildId: Snowflake, guildBanner: string, format: Format_4): `/banners/${string}/${string}.${Format_4}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP, GIF
     */
    userBanner<Format_5 extends UserBannerFormat>(userId: Snowflake, userBanner: string, format: Format_5): `/banners/${string}/${string}.${Format_5}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP, GIF
     */
    userAvatar<Format_6 extends UserAvatarFormat>(userId: Snowflake, userAvatar: string, format: Format_6): `/avatars/${string}/${string}.${Format_6}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP, GIF
     */
    guildMemberAvatar<Format_7 extends GuildMemberAvatarFormat>(guildId: Snowflake, userId: Snowflake, memberAvatar: string, format: Format_7): `/guilds/${string}/users/${string}/avatars/${string}.${Format_7}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    applicationIcon<Format_8 extends ApplicationIconFormat>(applicationId: Snowflake, applicationIcon: string, format: Format_8): `/app-icons/${string}/${string}.${Format_8}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    applicationCover<Format_9 extends ApplicationCoverFormat>(applicationId: Snowflake, applicationCoverImage: string, format: Format_9): `/app-icons/${string}/${string}.${Format_9}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    applicationAsset<Format_10 extends ApplicationAssetFormat>(applicationId: Snowflake, applicationAssetId: string, format: Format_10): `/app-assets/${string}/${string}.${Format_10}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    achievementIcon<Format_11 extends AchievementIconFormat>(applicationId: Snowflake, achievementId: Snowflake, achievementIconHash: string, format: Format_11): `/app-assets/${string}/achievements/${string}/icons/${string}.${Format_11}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    stickerPackBanner<Format_12 extends StickerPackBannerFormat>(stickerPackBannerAssetId: Snowflake, format: Format_12): `/app-assets/710982414301790216/store/${string}.${Format_12}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    storePageAsset<Format_13 extends StorePageAssetFormat = ImageFormat.PNG>(applicationId: Snowflake, assetId: string, format?: Format_13): `/app-assets/${string}/store/${string}.${Format_13}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    teamIcon<Format_14 extends TeamIconFormat>(teamId: Snowflake, teamIcon: string, format: Format_14): `/team-icons/${string}/${string}.${Format_14}`;
    /**
     * Route for:
     ...
     */
    sticker<Format_15 extends StickerFormat>(stickerId: Snowflake, format: Format_15): `/stickers/${string}.${Format_15}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    roleIcon<Format_16 extends RoleIconFormat>(roleId: Snowflake, roleIcon: string, format: Format_16): `/role-icons/${string}/${string}.${Format_16}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    guildScheduledEventCover<Format_17 extends GuildScheduledEventCoverFormat>(guildScheduledEventId: Snowflake, guildScheduledEventCoverImage: string, format: Format_17): `/guild-events/${string}/${string}.${Format_17}`;
    /**
     * Route for:
     ...
     * This route supports the extensions: PNG, JPEG, WebP, GIF
     */
    guildMemberBanner<Format_18 extends GuildMemberBannerFormat>(guildId: Snowflake, userId: Snowflake, guildMemberBanner: string, format: Format_18): `/guilds/${string}/users/${string}/banners/${string}.${Format_18}`;
};
