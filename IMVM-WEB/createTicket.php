...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Assuming the session variable you want to pass is stored in a PHP variable named $sessionValue
            var sessionValue = "<?php echo $_SESSION['user']; ?>";
            document.getElementById('sessionValue').value = sessionValue;
        });
