...
<body>
    ...
    <form class="formticket" action="./php/createTicketConfirm.php" method="POST">
        ...
        <div style="margin-top: 10px;">
            <button type="submit" class="btn btn-primary py-2 px-3" action="submitForm()">SUBMIT</button>
        </div>
    </form>
