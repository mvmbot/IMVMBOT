            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100"
                        src="https://droplr.com/wp-content/uploads/2020/09/discord-bots-e1635362784159.png" alt="Image">
                            ...
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">VERSION BETA TESTER
                                        0.911-i</h1>
                                    <a href="" class="btn btn-primary py-3 px-5 animated slideInDown">READ MORE<i
                ...
                <div class="carousel-item">
                    <img class="d-block w-100"
                        src="https://techcult.com/wp-content/uploads/2021/09/Discord-Commands-List.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center">
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 pt-4 order-lg-last" style="min-height: 400px;">
                    <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img class="position-absolute img-fluid w-100 h-100"
                            src="https://droplr.com/wp-content/uploads/2020/09/discord-bots-e1635362784159.png"
                ...
                <div class="col-lg-6">
                    ...
                    <a href="IMVM-WEB/VERSION BETA TESTER 0.911-i.php" class="btn btn-primary py-3 px-5">Read more<i
                            class="fa fa-arrow-right ms-3"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 pt-4" style="min-height: 400px;">
                    <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img class="position-absolute img-fluid w-100 h-100"
                            src="https://techcult.com/wp-content/uploads/2021/09/Discord-Commands-List.jpg"
                            style="object-fit: cover;" alt="Disc beta">
                        <div class="position-absolute top-0 end-0 mt-n4 me-n4 py-4 px-5"
                ...
                <div class="col-lg-6">
                    ...
                    <a href="Cadillac Andretti a un paso de ser escuderia de la Formula"
                        class="btn btn-primary py-3 px-5">Read more<i class="fa fa-arrow-right ms-3"></i></a>
                </div>
            </div>
        </div>
    </div>
