                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <a href="./VERSION 1.php" class="btn btn-primary py-3 px-5 animated slideInDown">READ MORE<i
                            ...
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">VERSION BETA TESTER
                                        0.911-i</h1>
                                    <a href="./BETA TESTER 0.911-i.php" class="btn btn-primary py-3 px-5 animated slideInDown">READ MORE<i
                                            class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">VERSION BETA TESTER
                                        0.910-i</h1>
                                    <a href="./BETA TESTER 0.910-i.php" class="btn btn-primary py-3 px-5 animated slideInDown">READ MORE<i
                                            class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4"><span class="text-light">VERSION 1 IS <span
                                style="color: #9900ff;">NOW LIVE!</span>, updates & errors fixeds.</span></h1>
                    <!-- Titulo noticia -->
