        ...
        <table
            ...
            <tbody>
                ...
                <tr style="padding: 10px;">
                    <td style="width: 400px; padding: 15px 0px 25px 25px; vertical-align: top;">
                        ...
                        <p style="font-style: italic;margin-bottom:10px;">A new ticket has been received by the Our
                            Company Help Desk system.</p>
                        <p style="margin-bottom: 10px;">Someone will contact you shortly.</p>

                        {% when 'admin' or 'helpdesk_admin' %}

                        <p style="font-style: italic;margin-bottom:10px;">A new ticket has been added to our Help Desk
                            system.</p>
                        ...
                        <p style="font-style: italic;margin-bottom:10px;">On {{ticket.last_comment.created_at |
                            date_sw}},</p>
                        ...
                        <p style="font-style: italic;margin-bottom:10px;">On {{ticket.last_comment.created_at |
                            date_sw}},</p>
                        <p style="font-style: italic;margin-bottom:10px;">Ticket #{{ticket.id}} was assigned to
                            <strong>{{ticket.assignee.full_name_or_email}}</strong>.
                        </p>
                        ...
                        <p style="font-style: italic;margin-bottom:10px;">Ticket #{{ticket.id}} created on
                            {{ticket.created_at | date_sw}} has been assigned to<strong>
                                {{ticket.assignee.full_name_or_email}}</strong> by
                            <strong>{{ticket.last_comment.creator.full_name_or_email}}</strong>.
                        </p>
                        {% if events contains 'ticket-comment' %}
                        ...
                        <p style="font-style: italic;margin-bottom:10px;">On {{ticket.last_comment.created_at | date_sw
                            ...
                            <strong>{{ticket.last_comment.creator.full_name_or_email}}</strong> wrote:
                        </p>
                        {{ticket.last_comment.body | escape | simple_format}}


                        {%when 'ticket-closed', 'ticket-closed-dup' %} {% case recipient.role %} {% when 'end_user' or
                        'reporting' %}

                        {% if events contains 'ticket-closed-dup' %}
                        <p>This ticket was closed as a duplicate of <a
                                href="{{ticket.master_ticket_url | escape}}">Ticket #{{ticket.master_ticket}}</a>.</p>
                        ...
                        <p style="font-style: italic;margin-bottom:10px;">Please do not reply to this email unless this
                            ticket has not been closed to your satisfaction. If you would like to thank<strong>
                                {{ticket.assignee.full_name_or_email}}</strong>, use the email link to the right.</p>
                        <!-- ************************************************************************** -->
		  ...
		  {% endif %}
		  	-->
                        ...
                        {% if events contains 'ticket-closed-dup' %}
                        <p>This ticket was closed as a duplicate of <a
                                href="{{ticket.master_ticket_portal_url | escape}}">Ticket
                                #{{ticket.master_ticket}}</a>.</p>
                        ...
                        <p style="font-style: italic;margin-bottom:10px;"><strong>Ticket #{{ticket.id}} has been
                                reopened.</strong></p>
                        ...
                        <p style="font-style: italic;margin-bottom:10px;">If this ticket has been re-opened in error,
                            please click on the
                        ...
                        <table
                            style="table-layout: fixed; width: 394px; border: 1px #ccc solid; background: #eee; font-size: 11px; font-family: verdana, sans-serif;">
                            <tr>
                                <td word-wrap: break-word;>
                                    <div style="margin: 9px;">
                                        <h2 style="margin-bottom:5px; margin-top:10px; font-size:12px;">TICKET
                                            #{{ticket.id}}</h2>

                                        <p style="margin-bottom: 10px;"><strong>Summary:</strong> {{ticket.summary |
                                            escape}}</p>

                                        <p style="margin-bottom: 10px;"><strong>Description:</strong></p>{{ticket.body |
                                        escape | simple_format}}
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table
                            style="table-layout: fixed; border: 1px #ccc solid; background: #eee; width: 394px; font-size: 11px; font-family: verdana, sans-serif;">
                            <tr>
                                <td word-wrap: break-word;>
                                    <div style="margin: 9px;">
                                        <h2 style="margin-bottom:5px; margin-top:10px; font-size:12px;">Ticket History
                                        </h2>
                                        ...
                                        <p
                                            style="margin-bottom:10px; margin-top:2px; font-style: italic;color: #606060;">
                                            On {{comment.created_at | date_sw }}
