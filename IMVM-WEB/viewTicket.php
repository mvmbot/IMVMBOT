...
<body>
    ...
    <body>
                ...
                <div class="table-bordered table-hover table-responsive" style="width: 100%">
                    <table class="table" id="ticketTable" style="background-color:rgb(255, 255, 255)">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row["Reported By"] . "</td>";
                            echo "<td>" . $row["Status"] . "</td>";
                            // Insertar el icono en la columna "Action"
                        ...
                        <tr>
                            <th>1</th>
                            <th>Add a new command</th>
                            <th>Feature request</th>
                            <th>Mark </th>
                            <th>Open </th>
                            <th><button class="icon-button" aria-label="Action"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#6602a8" d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"/></svg></button></th>
                        </tr>
                        <tr>
                            <th>2 </th>
                            <th>Error in web </th>
        ...
        ?>
       <center>
        <a href="./createTicket.php" class="btn btn-primary py-3 px-5">NEW TICKET <svg xmlns="http://www.w3.org/2000/svg" height="20" width="22.5" viewBox="0 0 576 512"><path fill="#ffffff" d="M64 64C28.7 64 0 92.7 0 128v64c0 8.8 7.4 15.7 15.7 18.6C34.5 217.1 48 235 48 256s-13.5 38.9-32.3 45.4C7.4 304.3 0 311.2 0 320v64c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V320c0-8.8-7.4-15.7-15.7-18.6C541.5 294.9 528 277 528 256s13.5-38.9 32.3-45.4c8.3-2.9 15.7-9.8 15.7-18.6V128c0-35.3-28.7-64-64-64H64zm64 112l0 160c0 8.8 7.2 16 16 16H432c8.8 0 16-7.2 16-16V176c0-8.8-7.2-16-16-16H144c-8.8 0-16 7.2-16 16zM96 160c0-17.7 14.3-32 32-32H448c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H128c-17.7 0-32-14.3-32-32V160z"/></svg></a>        
    </center>
    </body>
