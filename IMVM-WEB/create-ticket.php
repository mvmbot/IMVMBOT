    ...
    <div class="createticket">
        <form class="formticket">
            <h1>Create a ticket</h4>
                ...
                <div id="additionalFields" style="display: none;">
                    <!-- Campos adicionales para cada opción -->
        ...
        <script>
            function showFields() {
                ...
                // Muestra los campos adicionales correspondientes al valor seleccionado usando switch
                switch (selectedValue) {
                    case "helpSupport":
                        document.getElementById("additionalField1").style.display = "block";
                        break;
                    case "bugReport":
                        document.getElementById("additionalField2").style.display = "block";
                        break;
                    case "featureRequest":
                        document.getElementById("additionalField2").style.display = "block";
                        break;
