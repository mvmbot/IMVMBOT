    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="mb-4 text-white">
                <center>
                    <p>Introducing our dynamic team of four individuals, united by a shared passion for programming and
                        a common background in advanced programming studies.
                        We first crossed paths during our time in a higher education program, and since 2023, we have
                        been dedicated to revolutionizing the landscape of computer science education. <br>Our
                        collective vision
                        is to streamline the learning experience by leveraging the widespread popularity of Discord.</p>
                </center><br>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/jara.png" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                                <a class="btn btn-square mx-1" href="https://github.com/jarasw"><i class="fab fa-github"></i></a>
                                <a class="btn btn-square mx-1" href="https://twitter.com/jaratw_"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square mx-1" href="https://www.instagram.com/joeeljm/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Joel Jara</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/alvaro.png" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                                <a class="btn btn-square mx-1" href="https://github.com/afernandezmvm/"><i class="fab fa-github"></i></a>
                                <a class="btn btn-square mx-1" href="https://twitter.com/Zhou_Liang__"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square mx-1" href="https://www.instagram.com/mellamomiabuela/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Álvaro Fernández</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/espadas.png" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                                <a class="btn btn-square mx-1" href="https://github.com/joel-espadas/"><i class="fab fa-github"></i></a>
                                <a class="btn btn-square mx-1" href="https://twitter.com/ValtteriBottas"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square mx-1" href="https://www.instagram.com/joelespadaas/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Joel Espadas</h5>
                            <small>Back-end Developer</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            ...
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                                <a class="btn btn-square mx-1" href="https://github.com/ivanmvm/"><i class="fab fa-github"></i></a>
                                <a class="btn btn-square mx-1" href="https://twitter.com/aivanidk"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square mx-1" href="https://www.instagram.com/cristiano/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Iván Sáez</h5>
                            <small>JS Programming</small>
                        </div>
                    </div>
                </div>
            </div>
