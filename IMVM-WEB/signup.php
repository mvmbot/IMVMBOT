  ...
  <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        ...
        <a href="./our-services.html" class="nav-item nav-link">SERVICES</a>
        <a href="./FAQ.html" class="nav-item nav-link">FAQ</a>
        <a href="./Changelog.html" class="nav-item nav-link">CHANGELOG</a>
      </div>
    ...
    if (!isset($_POST['signup'])) {
      ...
      <form class="form" method="POST" action="signup.php">
        ...
        <div class="input-group">
          ...
          <p>
            Please confirm that you agree with our privacy policy<input type="checkbox" />
          </p>
        </div>
    ...
    <div class="container py-5">
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <a class="btn btn-link" href="./our-services.html">Our Services</a>
          <a class="btn btn-link" href="./privacy-policy.html">Privacy Policy</a>
          <a class="btn btn-link" href="./cookies-policy.html">Cookies</a>
        </div>
        <div class="col-lg-3 col-md-6">
      ...
      <div class="copyright">
        <div class="row">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <p>&copy; 2023 IESMVMBOT - All rights reserved - <a href="./privacy-policy.html">Política de
                privacidad</a></p>
